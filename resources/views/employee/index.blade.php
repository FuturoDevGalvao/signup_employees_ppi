                ...
                @forelse ($employees as $employee)
                    <tr
                        ...
                        <td scope="row" class="px-6 py-4">
                            ...
                            <a href="{{ route('addresses.create', ['employee' => $employee->id]) }}"
                        ...
                        <td scope="row" class="px-6 py-4">
                            ...
                            <a href="{{ route('phones.create', ['employee' => $employee->id]) }}"
                                class="flex items-center gap-1 py-1 px-1.5 text-sm font-medium focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                novo
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                        ...
                        <td scope="row" class="px-6 py-4">
                            <button data-modal-target="popup-modal-{{ $employee->name }}"
                                data-modal-toggle="popup-modal-{{ $employee->name }}"
                                class="flex items-center gap-1 py-1 px-1.5 text-sm font-medium focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                                type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                Deseja excluir o funcionário <span
                                                    class="font-semibold">{{ $employee->name }}</span>?</h3>
                                            <div class="flex gap-1 items-center justify-center">
                                                ...
                                                <button data-modal-hide="popup-modal-{{ $employee->name }}"
                                                    type="button"
