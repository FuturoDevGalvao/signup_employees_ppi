...
@section('content')
                    ...
                    <div class="text-blue-900 mx-auto mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 md:gap-8 lg:mt-16 lg:mr-0">
                        <div class="px-6 py-10">
                            <div class="flex items-center">
                                <h3 class="relative ml-2 inline-block text-2xl font-medium leading-none">
                                    <span class="absolute -top-6 -left-6 h-16 w-16 rounded-full bg-blue-200"></span>
                                    <span class="relative">Idade</span>
                                </h3>
                                <span class="ml-3 text-4xl font-bold capitalize">{{ $employee->age }}</span>
                            </div>
                        </div>
                        ...
                        <div class="px-6 py-10">
                            <div class="flex items-center">
                                ...
                                <span class="ml-3 text-4xl font-bold capitalize">{{ $employee->wage }}</span>
                            </div>
                        </div>
                        ...
                        <div class="px-6 py-10">
                            <div class="flex items-center">
                                ...
                                <span class="ml-3 text-4xl font-bold capitalize">{{ $employee->addresses->count() }}</span>
                            </div>
                        </div>
                        ...
                        <div class="px-6 py-10">
                            <div class="flex items-center">
                                ...
                                <span class="ml-3 text-4xl font-bold capitalize">{{ $employee->phones->count() }}</span>
                            </div>
                        </div>

                        <div class="px-6 py-10">
                            <div class="flex items-center">
                                <h3 class="relative ml-2 inline-block text-2xl font-bold leading-none">
                                    <span class="absolute -top-6 -left-6 h-16 w-16 rounded-full bg-blue-200"></span>
                                    <span class="relative">Imagens</span>
                                </h3>
                                <span class="ml-3 text-4xl font-bold capitalize">{{ $employee->images->count() }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @else
        <h1>Não há nenhum funcioário registrado</h1>
    @endif
@endsection
