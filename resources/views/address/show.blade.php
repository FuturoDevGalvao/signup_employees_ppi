...
@section('content')
    <div class="w-[90%] relative overflow-x-auto flex flex-col gap-4">
        ...
        <div class="mb-2">
            <h1 class="font-bold text-3xl">Endereços Associados</h1>
        ...
        @if ($showModal)
            @if ($success)
                <div id="alert-border-3"
                    ...
                    <div class="ms-3 text-sm font-medium">
                        O endereço foi devidamente excluído.
                    </div>
                    <button type="button"
            ...
            @else
                <div id="alert-border-2"
                    ...
                    <div class="ms-3 text-sm font-medium">
                        <span class="font-semibold">Ocorreu um erro</span> na tentativa de exclusão. Por favor,
                        <span class="font-semibold">tente novamente</span>.
                    </div>
                    <button type="button"
            ...
            <tbody>
                @forelse ($employee->addresses as $address)
                    <tr
                        ...
                        <td class="py-4">
                            <button data-modal-target="popup-modal-{{ $address->id }}"
                                data-modal-toggle="popup-modal-{{ $address->id }}"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                Deseja excluir o endereço pertencente a <span
                                                    class="font-semibold">{{ $address->employee->name }}</span>?</h3>
                                            <div class="flex gap-1 items-center justify-center">
                                                ...
                                                <button data-modal-hide="popup-modal-{{ $address->id }}" type="button"
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center p-4">
                            <h1>Nenhum endereço associado</h1>
                        </td>
                    ...
                    <div class="flex gap-4 items-center">
                        ...
                        <a href="{{ route('addresses.create', ['employee' => $employee]) }}"
                            class="rounded-full inline-flex items-center justify-center font-semibold text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                            Cadastrar um endereço para {{ $employee->name }}
                        </a>
                    </div>
                @endforelse
            </tbody>
