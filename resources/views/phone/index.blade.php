...
@section('content')
    <div class="w-[80%] relative overflow-x-auto flex flex-col gap-4">
        <div class="flex full items-center justify-between">
            <h1 class="font-bold text-3xl">Lista de Telefones</h1>
        </div>
            ...
            @if ($success)
                <div id="alert-border-3"
                    ...
                    <div class="ms-3 text-sm font-medium">
                        O telefone pertencente a <span class="font-semibold">{{ $employeeOwnerDeletedPhone->name }}</span>
                        foi devidamente
                        excluído.
                    </div>
                    <button type="button"
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center p-4">
                            <h1>Nenhum telefone registrado</h1>
                        </td>
                    </tr>
                @endforelse
            </tbody>
